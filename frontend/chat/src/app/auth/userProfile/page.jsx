  ...
  return (
    <div className="container mt-5">
      ...
      <form className="form" style={{ display: "flex", flexDirection: "column"}} onSubmit={handleSubmit}>
        {loading && <div style={{ display: "flex", width: "100%", justifyContent: "center" }} ><img src="https://res.cloudinary.com/dbwmesg3e/image/upload/v1694041638/NoCountry/download-unscreen_j7cfgc.gif" alt="" style={{ width: "22%", height: "auto", marginTop: "10%", position: "fixed", alignContent: "center" }} /></div>}
        <div style={{ display: "flex", flexDirection: "row", alignContent: "center", width: "100%", justifyContent: "space-around", flexWrap: "wrap" , filter:loading?"blur(1px)":null }}>
          ...
          {/* imagen */}
          {loadingImage ? (
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }} ><img src="https://res.cloudinary.com/dbwmesg3e/image/upload/v1693864078/loading_..._hfexoy.gif" style={{ width: "150px", height: "auto" }} alt="cargando..." /></div>) :
